    ...
    <div class="wrapper">
        ...
        <nav class="navbar navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              <a href="AdminLTE/index2.html" class="navbar-brand"><b>Map</b>Event</a>
            ...
            <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
              <ul class="nav navbar-nav">
                <li class="active"><a href="maps">maps <span class="sr-only">(current)</span></a></li>
                <li><a href="#">Link</a></li>
                <li class="dropdown">
      ...
      <div class="content-wrapper">
        <div class="container">
          ...
          <img src="/img/medanmedan.jpg" width="100%" height="480px" alt="medan"> 
          </section><!-- /.content -->
        </div><!-- /.container -->
      </div><!-- /.content-wrapper -->
